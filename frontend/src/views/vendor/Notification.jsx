...
function Notifications() {
    ...
    const fetchUnseenData = async () => {
        try {
        const response = await apiInstance.get(`vendor-unseen-noti/${userData?.vendor_id}/`);
    ...
    const fetchSeenData = async () => {
        try {
        const response = await apiInstance.get(`vendor-seen-noti/${userData?.vendor_id}/`);
    ...
    const fetchStatsData = async () => {
        try {
        const response = await apiInstance.get(`vendor-noti-summary/${userData?.vendor_id}/`);
    ...
    const handleNotificationSeenStatus = async (notiId) => {
        try {
        const response = await apiInstance.get(`vendor-noti-mark-as-seen/${userData?.vendor_id}/${notiId}/`);
