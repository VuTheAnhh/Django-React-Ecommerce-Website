...
function UpdateProduct() {
  ...
  useEffect(() => {
    const fetchProductItems = async () => {
      axios.get(`vendor-update-product/${userData?.vendor_id}/${param.pid}/`).then((res) => {
        setProduct(res.data)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: 'Please fill all the needed fields',
      });
        ...
        <div className="row row-offcanvas row-offcanvas-left h-100">
          ...
          <div className="col-md-9 col-lg-10 main mt-4">
            <div className="container">
              <form className="main-body" method='PATCH ' encType="multipart/form-data" onSubmit={handleSubmit}>
                            ...
                            {gallery?.map((item, index) => (
                              ...
                              <div className="row text-dark mb-5">
                                <div className="col-lg-3">
                                  ...
                                  {!item.image && (
                                    <img
                                      src="https://th.bing.com/th/id/OIP.z7Z9NY1WbVmMiB8jTvBK4AHaEj?rs=1&pid=ImgDetMain"
                                      alt={`Preview for gallery item ${index + 1}`}
                                      style={{ width: '100%', height: '100px', objectFit: 'cover', borderRadius: 5 }}
                                    />
                                  )}
