                                ...
                                <div className="col-xs-12 col-sm-12 col-md-12 text-left">
                                    <div className="receipt-right">
                                        <h5 className="margin-top-10">
                                            Vu Interprise<span className="text-warning">.</span>
                                        </h5>
                                        <p>
                                            <i className="fa fa-phone" /> +84 774382049
                                        </p>
                                        <p>
                                            <i className="fa fa-envelope" /> vutheanh.ita@gmail.com
                                        </p>
                                        <p>
                                            <i className="fa fa-location-arrow" /> Lane 113, Nhon street, Bac Tu Liem district, Ha Noi
                                        </p>
                                    </div>
                                </div>
                            </div>
