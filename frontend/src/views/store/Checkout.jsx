                          ...
                          <div className="col-lg-4 mb-4 mb-md-0">
                              ...
                              <section className="shadow-4 p-4 rounded-5 mb-4">
                                  ...
                                  <div className="shadow p-3 d-flex mt-4 mb-4">
                                      <input onChange={(e) => setCouponCode(e.target.value)} name="couponCode" type="text" className='form-control' style={{ border: "dashed 1px gray" }} placeholder='Coupon Code' id="" />
                                ...
                                {paymentLoading === true && 
                                  <form action={`${SERVER_URL}/api/v1/stripe-checkout/${order.oid}/`} method='POST'>
                                    <button onClick={payWithStripe} disabled type="submit" className="btn btn-primary btn-rounded w-100 mt-2">
                                ...
                                {paymentLoading === false && 
                                  <form action={`${SERVER_URL}/api/v1/stripe-checkout/${order.oid}/`} method='POST'>
                                    <button onClick={payWithStripe} type="submit" className="btn btn-primary btn-rounded w-100 mt-2">
                                        Pay Now Stripe <i className='fas fa-credit-card'></i>
                                    </button>
