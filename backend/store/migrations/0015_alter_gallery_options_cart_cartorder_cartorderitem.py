# Generated by Django 5.0 on 2024-04-06 05:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('store', '0014_color_gallery_size_specification'),
        ('vendor', '0006_initial'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shiping_amount', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tax_fee', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('total', models.DecimalField(decimal_places=2, default=0.0, max_digits=12)),
                ('payment', models.CharField(choices=[('paid', 'Paid'), ('pending', 'Pending'), ('processing', 'Processing'), ('cancelled', 'Cancelled')], default='pending', max_length=100)),
                ('order_status', models.CharField(choices=[('paid', 'Paid'), ('pending', 'Pending'), ('processing', 'Processing'), ('cancelled', 'Cancelled')], default='Pending', max_length=100)),
